...
export type FooterQueryVariables = StorefrontAPI.Exact<{
  ...
  footerMenuSecondHandle: StorefrontAPI.Scalars['String']['input'];
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
export type FooterQuery = {
  ...
  >;
  secondMenu?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Menu, 'id'> & {
      items: Array<
        Pick<
          StorefrontAPI.MenuItem,
...
export type PhoenixHomepageMetaobjectsQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type PhoenixHomepageMetaobjectsQuery = {
  comparisonRows: {
    nodes: Array<{
      fields: Array<
...
type MetaobjectFile_XtgPrfAUeI6VsWsFlbX5ahJLt5uDeMu18L6xpO4hUqu_Fragment = {};

type MetaobjectFile_GenericFile_Fragment = Pick<
  StorefrontAPI.GenericFile,
  'url'
>;

type MetaobjectFile_MediaImage_Fragment = {
  image?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Image, 'url'>>;
};

export type MetaobjectFileFragment =
  | MetaobjectFile_XtgPrfAUeI6VsWsFlbX5ahJLt5uDeMu18L6xpO4hUqu_Fragment
  | MetaobjectFile_GenericFile_Fragment
  | MetaobjectFile_MediaImage_Fragment;

export type PhoenixHomepageProductQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
}>;

export type PhoenixHomepageProductQuery = {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query PhoenixHomepageMetaobjects {\n    comparisonRows: metaobjects(type: "comparison_row", first: 50) {\n      nodes { fields { key value reference { ...MetaobjectFile } } }\n    }\n    steps: metaobjects(type: "step_item", first: 10) {\n      nodes { fields { key value reference { ...MetaobjectFile } } }\n    }\n    boxItems: metaobjects(type: "box_item", first: 30) {\n      nodes { fields { key value reference { ...MetaobjectFile } } }\n    }\n    labReports: metaobjects(type: "lab_report", first: 20) {\n      nodes { fields { key value reference { ...MetaobjectFile } } }\n    }\n  }\n  fragment MetaobjectFile on MetafieldReference {\n    ... on MediaImage { image { url } }\n    ... on GenericFile { url }\n  }\n': {
    return: PhoenixHomepageMetaobjectsQuery;
    variables: PhoenixHomepageMetaobjectsQueryVariables;
  };
  '#graphql\n  query PhoenixHomepageProduct($handle: String!, $language: LanguageCode, $country: CountryCode) @inContext(language: $language, country: $country) {\n    product(handle: $handle) {\n      id\n      title\n      description\n      handle\n      priceRange {\n        minVariantPrice {\n          amount\n          currencyCode\n        }\n        maxVariantPrice {\n          amount\n          currencyCode\n        }\n      }\n      compareAtPriceRange {\n        minVariantPrice {\n          amount\n          currencyCode\n        }\n      }\n      variants(first: 10) {\n        nodes {\n          id\n          title\n          availableForSale\n          price {\n            amount\n            currencyCode\n          }\n          compareAtPrice {\n            amount\n            currencyCode\n          }\n          selectedOptions {\n            name\n            value\n          }\n          image {\n            url\n            altText\n            width\n            height\n          }\n        }\n      }\n      images(first: 10) {\n        nodes {\n          url\n          altText\n          width\n          height\n        }\n      }\n    }\n  }\n': {
    return: PhoenixHomepageProductQuery;
    variables: PhoenixHomepageProductQueryVariables;
  };
